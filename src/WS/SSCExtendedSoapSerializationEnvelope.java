...
public class SSCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SSCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SSCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SSCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SSCDateTimeConverter dateTimeConverter = new SSCStandardDateTimeConverter();

    public SSCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SSCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SSCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SSCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SSCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SSCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
