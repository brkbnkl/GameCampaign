...
public class SSCKPSPublicSoap
{
    ...
    public SSCKPSPublicSoap(){}

    public SSCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SSCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SSCExtendedSoapSerializationEnvelope envelope= new SSCExtendedSoapSerializationEnvelope(SSCExtendedSoapSerializationEnvelope.VER11);
